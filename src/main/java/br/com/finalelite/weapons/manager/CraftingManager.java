...
public class CraftingManager {
    ...
    @Deprecated //Para exclusivo uso interno em lores.
    ...
    public void registerDefaults() {
        List<String> DEFAULT_LORE = Text.translate(
                " &7???",
                " ",
                " &7Raridade: &9?&5?&6?",
        ...
        /* AMULET */
        ItemStack amulet = new ItemBuilder(Material.END_CRYSTAL)
                .name("&a&k................")
                .lore(Text.translate(
                        ...
                        CRAFTING_TAG_AMULET))
                .build();
        Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(Weapons.getWeapons(), "amulet"), amulet).shape(
                " x ",
                "xxx",
                " x ")
                .setIngredient('x', Material.EMERALD));
